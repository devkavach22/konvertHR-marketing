    ...
    <footer className="relative overflow-hidden text-gray-700">
      ...
      <div className="bg-[#E42128] text-white py-14 px-6 text-center relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <Link
            to="/contact"
            className="inline-flex items-center gap-2 bg-white text-[#E42128] px-6 py-3 rounded-full font-semibold hover:bg-[#ffe6e6] transition-all shadow-lg hover:shadow-xl"
          >
      ...
      <div className="relative bg-gradient-to-b from-white to-[#FFF6F6] pt-20 pb-10 px-6">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-5 gap-10 border-b border-gray-200 pb-10">
            ...
            <div className="flex space-x-4 mt-6">
              {socialIcons.map(({ Icon, label, link }, i) => (
                <a
                  ...
                  href={link}
                  aria-label={label}
                  className="p-2 rounded-full border border-gray-300 hover:bg-[#E42128] hover:text-white text-gray-700 transition-all hover:-translate-y-1"
                >
                  <Icon size={18} />
                </a>
              ))}
          ...
          {/* === Quick Links (Mapped to AppRoutes) === */}
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link
                  to="/services"
                  className="hover:text-[#E42128] transition flex items-center gap-2"
                >
                  HR Services
                </Link>
              </li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/" className="hover:text-[#E42128] transition">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/team" className="hover:text-[#E42128] transition">
                  Meet the Team
                </Link>
              </li>
              <li>
                <Link to="/contact" className="hover:text-[#E42128] transition">
                  Contact Support
                </Link>
              </li>
              <li>
                <Link to="/login" className="hover:text-[#E42128] transition">
                  Login
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex items-start space-x-3">
                <MapPin size={18} className="text-[#E42128] mt-1 shrink-0" />
                <span>
              ...
              <li className="flex items-start space-x-3">
                <Phone size={18} className="text-[#E42128] mt-1 shrink-0" />
                <a
                  href="tel:+9107228888904"
                  className="hover:text-[#E42128] transition"
                >
                  +91 072288 88904
                </a>
              </li>
              <li className="flex items-start space-x-3">
                <Mail size={18} className="text-[#E42128] mt-1 shrink-0" />
                <a
                  href="mailto:support@konverthr.com"
                  className="hover:text-[#E42128] transition"
                >
                  support@konverthr.com
                </a>
              </li>
            </ul>
          </div>
